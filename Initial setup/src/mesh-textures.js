...
const groundWoodAlbedo = textureLoader.load(
  "./textures/GroundWoodChips001/GroundWoodChips001_COL_2K.jpg"
);
const groundWoodAo = textureLoader.load(
  "./textures/GroundWoodChips001/GroundWoodChips001_AO_2K.jpg"
);
const groundWoodHeight = textureLoader.load(
  "./textures/GroundWoodChips001/GroundWoodChips001_DISP_2K.jpg"
);
const groundWoodNormal = textureLoader.load(
  "./textures/GroundWoodChips001/GroundWoodChips001_NRM_2K.jpg"
);
const groundWoodRoughness = textureLoader.load(
  "./textures/GroundWoodChips001/GroundWoodChips001_GLOSS_2K.jpg"
);
const groundWoodMetallic = textureLoader.load(
  "./textures/GroundWoodChips001/GroundWoodChips001_REFL_2K.jpg"
);
